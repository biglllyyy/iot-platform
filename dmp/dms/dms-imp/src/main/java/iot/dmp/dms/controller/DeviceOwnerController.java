...
import iot.dmp.dms.service.DeviceInfoServiceImpl;
import iot.dmp.dms.service.DeviceOwnerServiceImpl;
...
public class DeviceOwnerController {
    private Logger LOG = LoggerFactory.getLogger(DeviceOwnerController.class);
    ...
    public Result<?> getDeviceInfoByOwnerId(@RequestParam("ownerId") String ownerId, @RequestParam("pageIndex") int
        ...
        QueryResult<DeviceInfoDto> deviceInfoQueryResult;
        try {
    ...
    public Result<?> findDeviceByParams(
        ...
        QueryResult<DeviceInfoDto> result;
        try {
