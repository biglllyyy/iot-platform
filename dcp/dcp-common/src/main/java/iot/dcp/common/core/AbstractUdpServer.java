...
public abstract class AbstractUdpServer extends AbstractServer {
    ...
    public void start() {
        ...
        try {
            ...
            ChannelInitializer<DatagramChannel> channelInitializer = getChannelInitializer(dcsProperties);
    ...
    protected ChannelInitializer<DatagramChannel> getChannelInitializer(DcsProperties dcsProperties) {
